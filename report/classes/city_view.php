...
class city_view extends city
{
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("city_id") !== NULL) {
			$this->RecKey["city_id"] = Get("city_id");
			$keyUrl .= "&amp;city_id=" . urlencode($this->RecKey["city_id"]);
		}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "citylist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "citylist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
