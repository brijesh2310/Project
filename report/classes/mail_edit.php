...
class mail_edit extends mail
{
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("maillist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "maillist.php")
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// telephone
			$this->telephone->setDbValueDef($rsnew, $this->telephone->CurrentValue, "", $this->telephone->ReadOnly);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("maillist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
