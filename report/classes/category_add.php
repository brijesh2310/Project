...
class category_add extends category
{
	...
	public function run()
	{
		...
		$this->category_img->setVisibility();
	...
	protected function loadDefaultValues()
	{
		...
		$this->category_img->CurrentValue = NULL;
		$this->category_img->OldValue = $this->category_img->CurrentValue;
	}
	...
	protected function loadFormValues()
	{
		...
		// Check field name 'category_img' first before field var 'x_category_img'
		$val = $CurrentForm->hasValue("category_img") ? $CurrentForm->getValue("category_img") : $CurrentForm->getValue("x_category_img");
		if (!$this->category_img->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->category_img->Visible = FALSE; // Disable update for API request
			else
				$this->category_img->setFormValue($val);
		}
	...
	public function restoreFormValues()
	{
		...
		$this->category_img->CurrentValue = $this->category_img->FormValue;
	}
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->category_img->setDbValue($row['category_img']);
	}
	...
	protected function newRow()
	{
		...
		$row['category_img'] = $this->category_img->CurrentValue;
		return $row;
	}
	...
	protected function loadOldRecord()
	{
		...
		if (strval($this->getKey("category_id")) != "")
			$this->category_id->OldValue = $this->getKey("category_id"); // category_id
		else
			$validKey = FALSE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			// category_img
			$this->category_img->ViewValue = $this->category_img->CurrentValue;
			$this->category_img->ViewCustomAttributes = "";
			...
			// category_img
			$this->category_img->LinkCustomAttributes = "";
			$this->category_img->HrefValue = "";
			$this->category_img->TooltipValue = "";
			...
			// category_img
			$this->category_img->EditAttrs["class"] = "form-control";
			$this->category_img->EditCustomAttributes = "";
			if (!$this->category_img->Raw)
				$this->category_img->CurrentValue = HtmlDecode($this->category_img->CurrentValue);
			$this->category_img->EditValue = HtmlEncode($this->category_img->CurrentValue);
			$this->category_img->PlaceHolder = RemoveHtml($this->category_img->caption());
	...
	protected function validateForm()
	{
		...
		if ($this->category_img->Required) {
			if (!$this->category_img->IsDetailKey && $this->category_img->FormValue != NULL && $this->category_img->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->category_img->caption(), $this->category_img->RequiredErrorMessage));
			}
		}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// category_img
		$this->category_img->setDbValueDef($rsnew, $this->category_img->CurrentValue, "", FALSE);
