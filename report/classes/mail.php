...
class mail extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('mail', 'mail', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// name
		$this->name = new DbField('mail', 'mail', 'x_name', 'name', '`name`', '`name`', 200, 50, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// email
		$this->_email = new DbField('mail', 'mail', 'x__email', 'email', '`email`', '`email`', 200, 50, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// telephone
		$this->telephone = new DbField('mail', 'mail', 'x_telephone', 'telephone', '`telephone`', '`telephone`', 200, 10, -1, FALSE, '`telephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// message
		$this->message = new DbField('mail', 'mail', 'x_message', 'message', '`message`', '`message`', 200, 255, -1, FALSE, '`message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`mail`";
	}
	...
	{
		global $Language;
		if ($pageName == "mailview.php")
			return $Language->phrase("View");
		elseif ($pageName == "mailedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "mailadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("mailview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("mailview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "mailadd.php?" . $this->getUrlParm($parm);
		else
			$url = "mailadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mailedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mailadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("maildelete.php", $this->getUrlParm());
	}
