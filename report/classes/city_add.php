	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("city_id") !== NULL) {
				...
				$this->setKey("city_id", $this->city_id->CurrentValue); // Set up key
			} else {
				$this->setKey("city_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "cityview.php")
