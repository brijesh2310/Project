 ...
 * Page class
 */
class sub_category_view extends sub_category
{
	...
	// Page object name
	public $PageObjName = "sub_category_view";
	...
	public function __construct()
	{
		...
		if (Get("subcategory_id") !== NULL) {
			$this->RecKey["subcategory_id"] = Get("subcategory_id");
			$keyUrl .= "&amp;subcategory_id=" . urlencode($this->RecKey["subcategory_id"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("subcategory_id") !== NULL) {
				...
				$this->subcategory_id->setQueryStringValue(Key(0));
				$this->RecKey["subcategory_id"] = $this->subcategory_id->QueryStringValue;
				...
				$this->subcategory_id->setFormValue(Route(2));
				$this->RecKey["subcategory_id"] = $this->subcategory_id->FormValue;
			} else {
				$returnUrl = "sub_categorylist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "sub_categorylist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "sub_categorylist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
