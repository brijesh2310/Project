 ...
 * Page class
 */
class registration_delete extends registration
{
	...
	// Page object name
	public $PageObjName = "registration_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("registrationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("registrationlist.php"); // Return to list
			}
		}
	}
