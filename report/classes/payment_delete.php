 ...
 * Page class
 */
class payment_delete extends payment
{
	...
	// Page object name
	public $PageObjName = "payment_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("paymentlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("paymentlist.php"); // Return to list
			}
		}
	}
