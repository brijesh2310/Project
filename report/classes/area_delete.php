 ...
 * Page class
 */
class area_delete extends area
{
	...
	// Page object name
	public $PageObjName = "area_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("arealist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("arealist.php"); // Return to list
			}
		}
	}
