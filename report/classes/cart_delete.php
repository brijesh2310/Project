 ...
 * Page class
 */
class cart_delete extends cart
{
	...
	// Page object name
	public $PageObjName = "cart_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cartlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("cartlist.php"); // Return to list
			}
		}
	}
