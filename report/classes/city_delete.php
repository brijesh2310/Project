 ...
 * Page class
 */
class city_delete extends city
{
	...
	// Page object name
	public $PageObjName = "city_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("citylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("citylist.php"); // Return to list
			}
		}
	}
