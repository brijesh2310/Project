 ...
 * Page class
 */
class sub_category_add extends sub_category
{
	...
	// Page object name
	public $PageObjName = "sub_category_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("subcategory_id") !== NULL) {
				$this->subcategory_id->setQueryStringValue(Get("subcategory_id"));
				$this->setKey("subcategory_id", $this->subcategory_id->CurrentValue); // Set up key
			} else {
				$this->setKey("subcategory_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("sub_categorylist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "sub_categorylist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "sub_categoryview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->subcategory_id->OldValue = $this->subcategory_id->CurrentValue;
		$this->subcategory_name->CurrentValue = NULL;
		$this->subcategory_name->OldValue = $this->subcategory_name->CurrentValue;
		$this->subcategory_img->CurrentValue = NULL;
		$this->subcategory_img->OldValue = $this->subcategory_img->CurrentValue;
	...
	protected function loadFormValues()
	{
		...
		// Check field name 'subcategory_img' first before field var 'x_subcategory_img'
		$val = $CurrentForm->hasValue("subcategory_img") ? $CurrentForm->getValue("subcategory_img") : $CurrentForm->getValue("x_subcategory_img");
		if (!$this->subcategory_img->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->subcategory_img->Visible = FALSE; // Disable update for API request
			else
				$this->subcategory_img->setFormValue($val);
		}
	...
	public function restoreFormValues()
	{
		...
		$this->subcategory_img->CurrentValue = $this->subcategory_img->FormValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['subcategory_id'] = $this->subcategory_id->CurrentValue;
		$row['subcategory_name'] = $this->subcategory_name->CurrentValue;
		$row['subcategory_img'] = $this->subcategory_img->CurrentValue;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->subcategory_img->EditValue = HtmlEncode($this->subcategory_img->CurrentValue);
	...
	protected function validateForm()
	{
		...
		if ($this->subcategory_img->Required) {
			if (!$this->subcategory_img->IsDetailKey && $this->subcategory_img->FormValue != NULL && $this->subcategory_img->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->subcategory_img->caption(), $this->subcategory_img->RequiredErrorMessage));
			}
		}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// subcategory_img
		$this->subcategory_img->setDbValueDef($rsnew, $this->subcategory_img->CurrentValue, "", FALSE);
