...
class product_add extends product
{
	...
	protected function loadDefaultValues()
	{
		...
		$this->product_img->CurrentValue = NULL;
		$this->product_img->OldValue = $this->product_img->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['product_img'] = $this->product_img->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// product_img
		$this->product_img->setDbValueDef($rsnew, $this->product_img->CurrentValue, "", FALSE);
