 ...
 * Page class
 */
class payment_view extends payment
{
	...
	// Page object name
	public $PageObjName = "payment_view";
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("a_id") !== NULL) {
			$this->RecKey["a_id"] = Get("a_id");
			$keyUrl .= "&amp;a_id=" . urlencode($this->RecKey["a_id"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("a_id") !== NULL) {
				...
				$this->RecKey["a_id"] = $this->a_id->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->a_id->setQueryStringValue(Key(0));
				$this->RecKey["a_id"] = $this->a_id->QueryStringValue;
			} elseif (Post("a_id") !== NULL) {
				$this->a_id->setFormValue(Post("a_id"));
				$this->RecKey["a_id"] = $this->a_id->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->a_id->setFormValue(Route(2));
				$this->RecKey["a_id"] = $this->a_id->FormValue;
			} else {
				$returnUrl = "paymentlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "paymentlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "paymentlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
