...
class view1 extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view1', 'view1', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// name
		$this->name = new DbField('view1', 'view1', 'x_name', 'name', '`name`', '`name`', 200, 20, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// email
		$this->_email = new DbField('view1', 'view1', 'x__email', 'email', '`email`', '`email`', 200, 50, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// password
		$this->password = new DbField('view1', 'view1', 'x_password', 'password', '`password`', '`password`', 200, 50, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// address
		$this->address = new DbField('view1', 'view1', 'x_address', 'address', '`address`', '`address`', 200, 50, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mobile
		$this->mobile = new DbField('view1', 'view1', 'x_mobile', 'mobile', '`mobile`', '`mobile`', 200, 10, -1, FALSE, '`mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
