 ...
 * Page class
 */
class sub_category_delete extends sub_category
{
	...
	// Page object name
	public $PageObjName = "sub_category_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("sub_categorylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("sub_categorylist.php"); // Return to list
			}
		}
	}
