...
class category extends DbTable
{
	...
	public function __construct()
	{
		...
		// category_id
		$this->category_id = new DbField('category', 'category', 'x_category_id', 'category_id', '`category_id`', '`category_id`', 3, 11, -1, FALSE, '`category_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// category_name
		$this->category_name = new DbField('category', 'category', 'x_category_name', 'category_name', '`category_name`', '`category_name`', 200, 20, -1, FALSE, '`category_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// category_img
		$this->category_img = new DbField('category', 'category', 'x_category_img', 'category_img', '`category_img`', '`category_img`', 200, 255, -1, FALSE, '`category_img`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->category_img->Nullable = FALSE; // NOT NULL field
		$this->category_img->Required = TRUE; // Required field
		$this->category_img->Sortable = TRUE; // Allow sort
		$this->fields['category_img'] = &$this->category_img;
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->category_img->DbValue = $row['category_img'];
	}
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("categoryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->category_img->setDbValue($rs->fields('category_img'));
	}
	...
	public function renderEditRow()
	{
		...
		$this->category_img->EditValue = $this->category_img->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->category_img);
				} else {
					$doc->exportCaption($this->category_id);
					$doc->exportCaption($this->category_name);
					$doc->exportCaption($this->category_img);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->category_img);
					} else {
						$doc->exportField($this->category_id);
						$doc->exportField($this->category_name);
						$doc->exportField($this->category_img);
