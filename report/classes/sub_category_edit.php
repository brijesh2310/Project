 ...
 * Page class
 */
class sub_category_edit extends sub_category
{
	...
	// Page object name
	public $PageObjName = "sub_category_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_subcategory_id")) {
				$this->subcategory_id->setFormValue($CurrentForm->getValue("x_subcategory_id"));
			}
		} else {
	...
	protected function validateForm()
	{
		...
		if ($this->subcategory_id->Required) {
			if (!$this->subcategory_id->IsDetailKey && $this->subcategory_id->FormValue != NULL && $this->subcategory_id->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->subcategory_id->caption(), $this->subcategory_id->RequiredErrorMessage));
			}
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// subcategory_img
			$this->subcategory_img->setDbValueDef($rsnew, $this->subcategory_img->CurrentValue, "", $this->subcategory_img->ReadOnly);
