 ...
 * Page class
 */
class rating_view extends rating
{
	...
	// Page object name
	public $PageObjName = "rating_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "ratinglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "ratinglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "ratinglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ratinglist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
