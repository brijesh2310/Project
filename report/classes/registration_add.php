 ...
 * Page class
 */
class registration_add extends registration
{
	...
	// Page object name
	public $PageObjName = "registration_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("registration_id") !== NULL) {
				...
				$this->setKey("registration_id", $this->registration_id->CurrentValue); // Set up key
			} else {
				$this->setKey("registration_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "registrationview.php")
