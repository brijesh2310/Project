...
<input type="text" data-table="city" data-field="x_city_name" name="x_city_name" id="x_city_name" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($city_edit->city_name->getPlaceHolder()) ?>" value="<?php echo $city_edit->city_name->EditValue ?>"<?php echo $city_edit->city_name->editAttributes() ?>>
</span>
