...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "16.0.11");
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'XzMDNb7iGhvIWCz1', // Random key for encryption
	...
	"PROJECT_ID" => "{2F902718-E095-40A0-B9CA-0712EAB83BB8}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "shopping"]
	],
